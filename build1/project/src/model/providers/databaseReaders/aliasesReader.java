...
public class aliasesReader extends dataReader {
	...
	private static aliasesReader self;
	...
	private aliasesReader() {
		
	}
	public static aliasesReader getInstance() {
		if (self!=null) {return self;}
		else {self = new aliasesReader();
		return self;}
	}
	@Override
